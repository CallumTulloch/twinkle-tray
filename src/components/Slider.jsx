        ...
        if (this.props.name) {
            return (
                <div className="name-row">
                    <div className="icon" style={{display: (this.props.icon === false ? "none" : "block")}}>{(this.props.iconContent !== undefined ? this.props.iconContent : (this.props.monitortype == "wmi" ? <span>&#xE770;</span> : <span>&#xE7F4;</span>))}</div>
